...
public class ColorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // display a single word. // This code with a few changes can be used for a GridView also
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (result == AudioManager.AUDIOFOCUS_REQUEST_GRANTED) {
                    // this make  us to have audio focus
    ...
    private void releaseMediaPlayer() {
        ...
        if (mediaPlayer != null) {
            ...
            // setting the media player to null is an easy way to tell that the media player is not configured to play an audio
            mediaPlayer = null;
